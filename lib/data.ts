...
export const mockTrucks: Truck[] = [
  ...
  },
  {
    ...
    name: 'Iron Wolf',
    driver: 'David Chen',
    plateNumber: 'TZ-6743-BH',
    type: 'flatbed',
    status: 'delayed',
    speed: 0,
    fuelLevel: 34,
    location: { lat: -6.1630, lng: 35.7516, city: 'Dodoma', country: 'Tanzania' },
  ...
  },
  {
    ...
    plateNumber: 'ET-3891-XZ',
    type: 'bulk',
    status: 'maintenance',
    speed: 0,
    fuelLevel: 15,
    location: { lat: 9.0250, lng: 38.7469, city: 'Addis Ababa', country: 'Ethiopia' },
...
export const mockPackages: Package[] = [
  {
    id: 'pkg-001',
    trackingNumber: 'TXL-2026-KE-48521',
    sender: 'TechHub Nairobi',
    receiver: 'Global Imports Ltd',
  ...
  {
    id: 'pkg-002',
    trackingNumber: 'TXL-2026-UG-72349',
    sender: 'MedSupply Uganda',
    receiver: 'Red Cross Nairobi',
  ...
  {
    id: 'pkg-003',
    trackingNumber: 'TXL-2026-RW-11087',
    sender: 'Kigali Coffee Co.',
    receiver: 'Amsterdam Roasters',
    ...
    status: 'pending',
    weight: 220,
    dimensions: 'Pallet (120x100x150 cm)',
    type: 'standard',
  ...
  {
    id: 'pkg-004',
    trackingNumber: 'TXL-2026-ET-93821',
    sender: 'Addis Gems Ltd',
    receiver: 'Antwerp Diamond House',
...
export const mockContainers: Container[] = [
  ...
  },
  {
    ...
    progress: 25,
    weight: 22.0,
    sealNumber: 'ML-887462',
    commodities: 'Fresh Fruits & Vegetables',
    events: [
  ...
  },
  {
    ...
    vessel: 'Evergreen Fortune',
    voyage: 'EF-2026-0562',
    progress: 100,
    weight: 18.2,
    sealNumber: 'ML-339184',
    commodities: 'Electronics & Auto Parts',
    events: [
      ...
      { timestamp: '2026-06-08 10:00', location: 'Mombasa, KE', status: 'Arrived', vessel: 'Evergreen Fortune', voyage: 'EF-2026-0562' },
    ],
  ...
  },
  {
    ...
    progress: 8,
    weight: 26.8,
    sealNumber: 'ML-551738',
    commodities: 'Agricultural Products & Textiles',
    events: [
      { timestamp: '2026-06-12 14:00', location: 'Mombasa, KE', status: 'Loading', vessel: 'COSCO Shipping Star', voyage: 'CS-2026-0491' },
      { timestamp: '2026-06-12 06:00', location: 'Mombasa, KE', status: 'At Terminal', description: 'Waiting for loading slot' },
    ],
  ...
  },
  {
    ...
    vessel: 'Yang Ming Wellbeing',
    voyage: 'YM-2026-0378',
    progress: 55,
    weight: 30.1,
    sealNumber: 'ML-773921',
    commodities: 'Machinery & Hardware',
    events: [
...
export const mockCargo: CargoShipment[] = [
  {
    id: 'crg-001',
    shipmentNumber: 'CARGO-2026-KE-00142',
    type: 'FCL',
    status: 'in_transit',
    origin: { lat: -1.2921, lng: 36.8219, city: 'Nairobi', country: 'Kenya' },
    destination: { lat: 25.2048, lng: 55.2708, city: 'Dubai', country: 'UAE' },
    currentLocation: { lat: -4.0435, lng: 39.6682, city: 'Mombasa', country: 'Kenya' },
    cargoType: 'Mixed Consumer Goods',
    weight: 45.2,
    volume: 68.5,
    containers: 3,
    trucks: 2,
    ...
    events: [
      ...
      { timestamp: '2026-06-10 14:00', location: 'Nairobi, KE', status: 'Warehouse', description: 'Cargo consolidated at hub', milestone: true },
    ],
  ...
  {
    id: 'crg-003',
    shipmentNumber: 'CARGO-2026-TZ-00234',
    type: 'rail',
    status: 'in_transit',
    origin: { lat: -6.7924, lng: 39.2083, city: 'Dar es Salaam', country: 'Tanzania' },
    ...
    cargoType: 'Fertilizer & Agricultural Inputs',
    weight: 1200,
    volume: 2400,
    containers: 24,
    trucks: 0,
  ...
  {
    id: 'crg-004',
    shipmentNumber: 'CARGO-2026-ET-00301',
    type: 'road',
    status: 'pending',
    origin: { lat: 9.0250, lng: 38.7469, city: 'Addis Ababa', country: 'Ethiopia' },
    ...
    cargoType: 'Emergency Relief Supplies',
    weight: 85.0,
    volume: 150.0,
    containers: 4,
    trucks: 6,
  ...
  {
    id: 'crg-005',
    shipmentNumber: 'CARGO-2026-CD-00056',
    type: 'FCL',
    status: 'delayed',
    origin: { lat: -4.3220, lng: 15.3082, city: 'Kinshasa', country: 'DRC' },
    destination: { lat: 34.0522, lng: -118.2437, city: 'Los Angeles', country: 'USA' },
    currentLocation: { lat: -8.8390, lng: 13.2894, city: 'Luanda', country: 'Angola' },
    cargoType: 'Coltan & Cobalt Ore',
    weight: 850,
    volume: 420,
    containers: 12,
    trucks: 4,
